...
3. 1で解凍したフォルダの中にある `translate.bat` を実行してください。
   ...
   **② PowerShellの実行確認（「実行しますか？」）が出た場合**
   ...
   ![実行確認](https://github.com/user-attachments/assets/08a195c7-3713-47c2-9067-7a67094aafbf)
   
   - Impostor Factoryのインストール先が自動的に検出され、翻訳の反映も自動で行われます。
